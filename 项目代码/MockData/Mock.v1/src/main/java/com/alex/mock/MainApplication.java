...
public class MainApplication {
    ...
    private static AppStart generateStart() {
        ...
        // mall
        appStart.setG(getRandomCharAndNumr(8) + "@mall.com");
        // 屏幕宽高 hw
                flag = rand.nextInt(4);
        switch (flag) {
            case 0:
    ...
    private static JSONObject generateError() {
        ...
        String[] errorBriefs = {"atcn.lift.dfdf.web.AbstractBaseController.validInbound(AbstractBaseController.java:72) ", "at cn.lift.appIn.control.CommandUtil.getInfo(CommandUtil.java:67)"};
